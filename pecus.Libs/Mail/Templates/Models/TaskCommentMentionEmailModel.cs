...
/// <summary>
/// タスクコメントメンション通知メールテンプレート用モデル
/// </summary>
public class TaskCommentMentionEmailModel : EmailTemplateModelBase, IEmailTemplateModel<TaskCommentMentionEmailModel>
{
    /// <inheritdoc />
    public static string TemplateName => "task-comment-mention";

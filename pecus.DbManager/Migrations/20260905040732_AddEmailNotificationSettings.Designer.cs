...
namespace pecus.DbManager.Migrations
{
    ...
    [Migration("20260905040732_AddEmailNotificationSettings")]
    partial class AddEmailNotificationSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pecus.Libs.DB.Models.ChatMessageMention", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("MentionedActorId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ChatMessageId", "MentionedActorId")
                        .IsUnique();

                    b.HasIndex("MentionedActorId", "CreatedAt");
            ...
            modelBuilder.Entity("Pecus.Libs.DB.Models.PersonalItemNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pecus.Libs.DB.Models.UserSetting", b =>
                {
                    ...
                    b.Property<bool>("CanReceiveWeeklyReport")
                        .HasColumnType("boolean");

                    b.Property<int?>("EmailNotificationMode")
                        .HasColumnType("integer");

                    b.PrimitiveCollection<List<int>>("EmailWorkspaceIds")
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("Pecus.Libs.DB.Models.ChatMessageMention", b =>
                {
                    b.HasOne("Pecus.Libs.DB.Models.ChatMessage", "ChatMessage")
                        .WithMany("Mentions")
                        .HasForeignKey("ChatMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pecus.Libs.DB.Models.ChatActor", "MentionedActor")
                        .WithMany()
                        .HasForeignKey("MentionedActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChatMessage");

                    b.Navigation("MentionedActor");
                });
            ...
            modelBuilder.Entity("Pecus.Libs.DB.Models.ExternalApiKey", b =>
                {
                    ...
                    b.HasOne("Pecus.Libs.DB.Models.User", "RevokedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Pecus.Libs.DB.Models.UserSetting", b =>
                {
                    ...
                    b.OwnsOne("Pecus.Libs.DB.Models.EmailNotificationCustomSettings", "CustomEmailSettings", b1 =>
                        {
                            b1.Property<int>("UserSettingId");

                            b1.Property<bool>("AgendaCancellationOrReminder");

                            b1.Property<bool>("AgendaInvitationOrUpdate");

                            b1.Property<bool>("AssignedItemUpdated");

                            b1.Property<bool>("DirectHelpWanted");

                            b1.Property<bool>("DirectMention");

                            b1.Property<bool>("DirectNeedReply");

                            b1.Property<bool>("DirectUrge");

                            b1.Property<bool>("GeneralComment");

                            b1.Property<bool>("ItemBodyUpdated");

                            b1.Property<bool>("PinnedItemActivity");

                            b1.Property<bool>("TaskAssignedCreated");

                            b1.Property<bool>("TaskOverdue");

                            b1.Property<bool>("TaskRelatedCompleted");

                            b1.Property<bool>("WorkspaceActivity");
                    ...
                    b.Navigation("CustomEmailSettings")
                        .IsRequired();

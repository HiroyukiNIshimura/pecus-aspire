...
------------ | ------------- | ------------- | -------------
**data** | [**Array&lt;WorkspaceUserDetailResponse&gt;**](WorkspaceUserDetailResponse.md) | データのリスト | [default to undefined]
...
```typescript
import { WorkspaceUserDetailResponsePagedResponse } from './api';

const instance: WorkspaceUserDetailResponsePagedResponse = {
    data,
    currentPage,
    pageSize,
    totalCount,

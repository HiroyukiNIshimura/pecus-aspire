...
export class MasterDataService {
   ...
   * @throws ApiError
   */
  public static getApiMasterGenres(): CancelablePromise<
    Array<MasterGenreResponse>
  > {
   ...
   * @throws ApiError
   */
  public static getApiMasterSkills(): CancelablePromise<
    Array<MasterSkillResponse>
  > {
    return __request(OpenAPI, {
      method: "GET",

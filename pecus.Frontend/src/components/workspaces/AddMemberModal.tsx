        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
          ...
          {selectedUser ? (
            ...
            <div className="my-4 flex flex-col flex-1 min-h-0">
              ...
              {/* 検索結果一覧 */}
              <div className="flex-1 overflow-y-auto border border-base-300 rounded-lg min-h-50 max-h-75">
                {!searchQuery.trim() ? (
          ...
          <div className="flex gap-2 justify-end pt-4 border-t border-base-300">
            <button type="button" className="btn btn-outline" onClick={handleClose} disabled={isAdding}>
              キャンセル
            </button>
            <button
              type="button"

    ...
    <div className="form-control">
      ...
      {selectedUser ? (
        <div className="flex items-center gap-2 p-2 bg-base-200 rounded-lg">
          ...
          <button type="button" className="btn btn-default btn-xs btn-circle" onClick={onClear} aria-label="選択解除">
            <svg
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-base-300 sticky top-0 bg-base-100 z-10">
          ...
          <button type="button" className="btn btn-default btn-circle btn-sm" aria-label="閉じる" onClick={onClose}>
            ✕
          </button>
        </div>

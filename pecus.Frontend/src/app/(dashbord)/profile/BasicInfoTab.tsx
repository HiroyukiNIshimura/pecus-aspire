...
export default function BasicInfoTab({
  ...
  return (
    <form
      ...
      noValidate
      className="space-y-6 bg-base-100"
    >
        ...
        <label className="label">
          <span className="label-text-alt text-base-content/60">
            {selectedAvatarType === "Gravatar" &&
              "メールアドレスに紐づいた Gravatar アバターを使用します"}
            {selectedAvatarType === "UserAvatar" &&
              "独自の画像をアップロードして使用します"}
            {selectedAvatarType === "AutoGenerated" &&
              "システムが自動生成したアバターを使用します"}
          </span>
        </label>
      </div>
        ...
        <div className="form-control">
          ...
          >
            ...
            {avatarPreviewUrl ? (
              ...
              >
                <div
                  className={`p-4 rounded-full transition-colors ${isDragging ? "bg-primary/20" : "bg-base-200"}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"

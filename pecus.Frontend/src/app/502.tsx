  ...
  return (
    <div className="relative flex items-center justify-center flex-1 overflow-hidden bg-linear-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6">
        {/* エラーコード */}
        <div className="mb-8">
          <h1 className="text-9xl font-bold bg-linear-to-r from-purple-400 via-indigo-400 to-blue-400 bg-clip-text text-transparent mb-4 animate-pulse">
            502
          </h1>
          <div className="h-1 w-24 bg-linear-to-r from-purple-400 to-blue-400 rounded-full mx-auto mb-6"></div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8 mb-6 max-w-xs mx-auto">
          <Link
            href="/"
            className="px-6 py-3 bg-linear-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-purple-500/50"
          >
            ホームに戻る
          </Link>
          <Link

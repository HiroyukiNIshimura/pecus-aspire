...
// Helper functions moved outside component to avoid re-render issues
...
function TableCellResizer({ editor }: { editor: LexicalEditor }): JSX.Element {
	...
	const getCellNodeHeight = useCallback((cell: TableCellNode, activeEditor: LexicalEditor): number | undefined => {

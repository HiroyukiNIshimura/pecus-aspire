...
function $createEquationNode(equation = "", inline = false) {
  ...
  return (0, import_lexical10.$applyNodeReplacement)(equationNode);
}
function $isEquationNode(node) {
  return node instanceof EquationNode;
}
var import_katex2, import_lexical10, React2, import_jsx_runtime6, EquationComponent, EquationNode;
var init_EquationNode = __esm({
  "src/nodes/EquationNode.tsx"() {
    ...
    EquationNode = class _EquationNode extends import_lexical10.DecoratorNode {
      __equation;
      __inline;
      static getType() {
        return "equation";
      ...
      decorate() {
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(EquationComponent, { equation: this.__equation, inline: this.__inline, nodeKey: this.__key });
      }
    };
  }
});
...
function useEmojis(editor) {
  (0, import_react10.useEffect)(() => {
    ...
    return editor.registerNodeTransform(import_lexical12.TextNode, $textNodeTransform);
  }, [editor]);
}
...
var import_LexicalComposerContext4, import_lexical12, import_react10, emojis;
...
function $createKeywordNode(keyword = "") {
  return (0, import_lexical13.$applyNodeReplacement)(new KeywordNode(keyword));
}
...
var init_KeywordNode = __esm({
  "src/nodes/KeywordNode.ts"() {
    ...
    KeywordNode = class _KeywordNode extends import_lexical13.TextNode {
      static getType() {
        return "keyword";
      }
      static clone(node) {
...
function $isCaptionEditorEmpty() {
  for (const { origin } of (0, import_lexical14.$extendCaretToRange)((0, import_lexical14.$getChildCaret)((0, import_lexical14.$getRoot)(), "next"))) {
    if (!(0, import_lexical14.$isElementNode)(origin)) {
      return false;
    }
  }
  return true;
...
function $createImageNode({
  ...
  return (0, import_lexical14.$applyNodeReplacement)(
...
var import_clipboard, import_hashtag, import_html, import_link, import_lexical14, React3, import_jsx_runtime13, ImageComponent, ImageNode;
var init_ImageNode2 = __esm({
  "src/nodes/ImageNode.tsx"() {
    ...
    ImageNode = class _ImageNode extends import_lexical14.DecoratorNode {
      __src;
      __altText;
      __width;
      __height;
      ...
      exportDOM() {
        ...
        if (this.__showCaption && this.__caption) {
          ...
          const captionHtml = captionEditor.read(() => {
            ...
            let selection = null;
            const firstChild = (0, import_lexical14.$getRoot)().getFirstChild();
            if ((0, import_lexical14.$isParagraphNode)(firstChild) && firstChild.getNextSibling() === null) {
              selection = (0, import_lexical14.$createRangeSelection)();
                  ...
                  if (figcaption) {
                    for (const imgNode of imageNodes) {
                      ...
                      imgNode.__caption.update(
                        () => {
                          const editor = (0, import_lexical14.$getEditor)();
                          (0, import_clipboard.$insertGeneratedNodes)(editor, (0, import_html.$generateNodesFromDOM)(editor, figcaption), (0, import_lexical14.$selectAll)());
                          (0, import_lexical14.$setSelection)(null);
                        },
                        { tag: import_lexical14.SKIP_DOM_SELECTION_TAG }
                      );
                    }
                  }
                  return imageNodes;
      ...
      constructor(src, altText, maxWidth, width, height, showCaption, caption, captionsEnabled, key) {
        ...
        this.__caption = caption || (0, import_lexical14.createEditor)({
          namespace: "Playground/ImageNodeCaption",
          nodes: [import_lexical14.RootNode, import_lexical14.TextNode, import_lexical14.LineBreakNode, import_lexical14.ParagraphNode, import_link.LinkNode, EmojiNode, import_hashtag.HashtagNode, KeywordNode]
        });
...
var import_LexicalComposerContext5, import_LexicalErrorBoundary, import_LexicalHashtagPlugin, import_LexicalNestedComposer, import_LexicalRichTextPlugin, import_useLexicalEditable2, import_useLexicalNodeSelection2, import_utils7, import_lexical15, import_react12, import_react_dom, import_jsx_runtime14, imageCache, RIGHT_CLICK_IMAGE_COMMAND;
...
var import_LexicalComposerContext6, import_useLexicalEditable3, import_lexical18, import_react13, import_jsx_runtime15, RENDER_DELAY_MS;
...
function $createMermaidNode(code = "") {
  return (0, import_lexical19.$applyNodeReplacement)(new MermaidNode(code));
}
function $isMermaidNode(node) {
  return node instanceof MermaidNode;
}
var import_lexical19, React4, import_jsx_runtime16, MermaidComponent2, MermaidNode;
var init_MermaidNode2 = __esm({
  "src/nodes/MermaidNode.tsx"() {
    ...
    MermaidNode = class _MermaidNode extends import_lexical19.DecoratorNode {
      __code;
      static getType() {
        return "mermaid";
      }
      ...
      decorate() {
        return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(MermaidComponent2, { code: this.__code, nodeKey: this.__key });
      }
      isIsolated() {
        return true;
      }
...
function StickyComponent({
  ...
  const handlePointerUp = (_event) => {
    ...
    if (stickyContainer !== null) {
      ...
      editor.update(() => {
        const node = (0, import_lexical22.$getNodeByKey)(nodeKey);
...
var import_lexical23, React5, import_jsx_runtime19, StickyComponent2, StickyNode;
var init_StickyNode2 = __esm({
  "src/nodes/StickyNode.tsx"() {
    ...
    StickyNode = class _StickyNode extends import_lexical23.DecoratorNode {
      __x;
      __y;
      __color;
      __caption;
      ...
      constructor(x, y2, color, caption, key) {
        ...
        this.__x = x;
        this.__y = y2;
        this.__caption = caption || (0, import_lexical23.createEditor)();
        this.__color = color;
      }
      exportJSON() {
        return {
      ...
      setPosition(x, y2) {
        ...
        writable.__x = x;
        writable.__y = y2;
        (0, import_lexical23.$setSelection)(null);
      }
      toggleColor() {
        const writable = this.getWritable();
...
var LayoutContainerNode = class _LayoutContainerNode extends import_lexical16.ElementNode {
  __templateColumns;
...
function $isEmptyLayoutItemNode(node) {
  ...
  return (0, import_lexical17.$isParagraphNode)(firstChild) && firstChild.isEmpty();
}
var LayoutItemNode = class _LayoutItemNode extends import_lexical17.ElementNode {
  static getType() {
    return "layout-item";
  }
  static clone(node) {
...
var PageBreakNode = class _PageBreakNode extends import_lexical20.DecoratorNode {
  static getType() {
    return "page-break";
  }
  static clone(node) {
    ...
    return {
      figure: (domNode) => {
        ...
        return {
          ...
          priority: import_lexical20.COMMAND_PRIORITY_HIGH
        };
      }
    };
  }
...
var SpecialTextNode = class _SpecialTextNode extends import_lexical21.TextNode {
  static getType() {
    return "specialText";
  }
  static clone(node) {
...
function $createSpecialTextNode(text = "") {
  return (0, import_lexical21.$applyNodeReplacement)(new SpecialTextNode(text));
}
...
var YouTubeNode = class _YouTubeNode extends import_LexicalDecoratorBlockNode3.DecoratorBlockNode {
  ...
  decorate(_editor, config) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(YouTubeComponent, { className, format: this.__format, nodeKey: this.getKey(), videoID: this.__id });
  }
};

...
var EquationComponent, equationState, inlineState, EquationNode;
var init_EquationNode = __esm({
  "src/nodes/EquationNode.tsx"() {
    ...
    EquationNode = class extends DecoratorNode2 {
      ...
      decorate() {
        return /* @__PURE__ */ jsx6(EquationComponent, { equation: this.getEquation(), inline: this.getInline(), nodeKey: this.__key });
      }
    };
  }
});
...
import { $create as $create9, TextNode as TextNode4 } from "lexical";
...
var ImageComponent, srcState, altTextState, widthState, heightState, maxWidthState, showCaptionState, captionsEnabledState, ImageNode;

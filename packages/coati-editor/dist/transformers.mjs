...
var init_EquationNode = __esm({
  "src/nodes/EquationNode.tsx"() {
    ...
    equationState = createState("equation", {
      parse: (v) => typeof v === "string" ? v : ""
    });
    inlineState = createState("inline", {
      parse: (v) => typeof v === "boolean" ? v : false
    });
    EquationNode = class extends DecoratorNode {
      $config() {
      ...
      decorate() {
        return /* @__PURE__ */ jsx4(EquationComponent2, { equation: this.getEquation(), inline: this.getInline(), nodeKey: this.__key });
      }
    };
  }
});
...
import { $create as $create2, $getState as $getState2, $setState as $setState2, createState as createState2, TextNode } from "lexical";
function $createEmojiNode(className, emojiText) {
  return $setState2($create2(EmojiNode).setTextContent(emojiText).setMode("token"), classNameState, className);
}
var classNameState, EmojiNode;
var init_EmojiNode = __esm({
  "src/nodes/EmojiNode.tsx"() {
    "use strict";
    classNameState = createState2("className", {
      parse: (v) => typeof v === "string" ? v : ""
    });
    EmojiNode = class extends TextNode {
      $config() {
      ...
      getClassName() {
        return $getState2(this, classNameState);
      }
      setClassName(valueOrUpdater) {
        return $setState2(this, classNameState, valueOrUpdater);
      }
    };
  }
});
...
import { $create as $create3, TextNode as TextNode2 } from "lexical";
var KeywordNode;
var init_KeywordNode = __esm({
  "src/nodes/KeywordNode.ts"() {
    "use strict";
    KeywordNode = class extends TextNode2 {
      $config() {
        return this.config("keyword", { extends: TextNode2 });
      }
      createDOM(config) {
...
function LexicalContentEditable({ className, placeholder, placeholderClassName }) {
  return /* @__PURE__ */ jsx7(
    ContentEditable,
    {
      ...
      placeholder: /* @__PURE__ */ jsx7("div", { className: placeholderClassName ?? "ContentEditable__placeholder", children: placeholder })
    }
  );
}
...
function ImageResizer({
  ...
  return /* @__PURE__ */ jsxs3("div", { ref: controlWrapperRef, children: [
    !showCaption && captionsEnabled && /* @__PURE__ */ jsx8(
      "button",
      {
        type: "button",
...
function CaptionOnChangePlugin({ parentEditor, nodeKey }) {
  const [captionEditor] = useLexicalComposerContext3();
  useEffect4(() => {
...
function LazyImage({
  ...
  if (status.error) {
    return /* @__PURE__ */ jsx9(BrokenImage, {});
  }
...
function ImageComponent({
  ...
  return /* @__PURE__ */ jsxs4(Suspense, { fallback: null, children: [
    /* @__PURE__ */ jsx9("div", { draggable, children: isLoadError ? /* @__PURE__ */ jsx9(BrokenImage, {}) : /* @__PURE__ */ jsx9(
      LazyImage,
      {
    ...
    showCaption && /* @__PURE__ */ jsx9("div", { className: "image-caption-container", children: /* @__PURE__ */ jsxs4(LexicalNestedComposer, { initialEditor: caption, children: [
      /* @__PURE__ */ jsx9(CaptionOnChangePlugin, { parentEditor: editor, nodeKey }),
      /* @__PURE__ */ jsx9(DisableCaptionOnBlur, { setShowCaption }),
      /* @__PURE__ */ jsx9(LinkPlugin, {}),
      /* @__PURE__ */ jsx9(EmojisPlugin, {}),
      /* @__PURE__ */ jsx9(HashtagPlugin, {}),
      /* @__PURE__ */ jsx9(
        RichTextPlugin,
        {
    ...
    resizable && isInNodeSelection && isFocused && /* @__PURE__ */ jsx9(
      ImageResizer,
      {
        showCaption,
        setShowCaption,
    ...
    isPreviewOpen && typeof document !== "undefined" && createPortal(
      /* @__PURE__ */ jsxs4(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx9("button", { type: "button", className: "image-preview-close", onClick: closePreview, "aria-label": "\u9589\u3058\u308B", children: /* @__PURE__ */ jsx9("span", { className: "icon-[mdi--close] size-5", "aria-hidden": "true" }) }),
            /* @__PURE__ */ jsx9("img", { src, alt: altText, className: "image-preview-content", draggable: "false" })
          ]
        }
      ),
      document.body
...
function $createImageNode({
  ...
  $setState3(node, srcState, src);
  $setState3(node, altTextState, altText ?? "");
  $setState3(node, widthState, width === void 0 || width === 0 ? "inherit" : width);
  $setState3(node, heightState, height === void 0 || height === 0 ? "inherit" : height);
  $setState3(node, maxWidthState, maxWidth);
  $setState3(node, showCaptionState, showCaption ?? false);
  $setState3(node, captionsEnabledState, captionsEnabled ?? true);
  if (caption) {
...
var init_ImageNode2 = __esm({
  "src/nodes/ImageNode.tsx"() {
    ...
    srcState = createState3("src", {
      parse: (v) => typeof v === "string" ? v : ""
    });
    altTextState = createState3("altText", {
      parse: (v) => typeof v === "string" ? v : ""
    });
    widthState = createState3("width", {
      parse: (v) => v === void 0 || v === null || v === 0 ? "inherit" : typeof v === "number" ? v : "inherit",
      unparse: (v) => v === "inherit" ? 0 : v
    });
    heightState = createState3("height", {
      parse: (v) => v === void 0 || v === null || v === 0 ? "inherit" : typeof v === "number" ? v : "inherit",
      unparse: (v) => v === "inherit" ? 0 : v
    });
    maxWidthState = createState3("maxWidth", {
      parse: (v) => typeof v === "number" ? v : 500
    });
    showCaptionState = createState3("showCaption", {
      parse: (v) => typeof v === "boolean" ? v : false
    });
    captionsEnabledState = createState3("captionsEnabled", {
      parse: (v) => typeof v === "boolean" ? v : true
    });
    ImageNode = class extends DecoratorNode2 {
      ...
      constructor(key = void 0) {
        ...
        this.__caption = createEditor({
          ...
          nodes: [RootNode, TextNode4, LineBreakNode, ParagraphNode, LinkNode, EmojiNode, HashtagNode, KeywordNode]
        });
      }
      ...
      setWidthAndHeight(width, height) {
        $setState3(this, widthState, width);
        $setState3(this, heightState, height);
      }
      setShowCaption(showCaption) {
        $setState3(this, showCaptionState, showCaption);
      }
      // View
      createDOM(config) {
      ...
      getSrc() {
        return $getState3(this, srcState);
      }
      getAltText() {
        return $getState3(this, altTextState);
      }
      getWidth() {
        return $getState3(this, widthState);
      }
      getHeight() {
        return $getState3(this, heightState);
      }
      getMaxWidth() {
        return $getState3(this, maxWidthState);
      }
      getShowCaption() {
        return $getState3(this, showCaptionState);
      }
      getCaptionsEnabled() {
        return $getState3(this, captionsEnabledState);
      }
      decorate() {
...
import { $create as $create4, $getState as $getState4, $setState as $setState4, buildImportMap as buildImportMap3, createState as createState4 } from "lexical";
...
function TweetComponent({
  ...
  const [isTweetLoading, setIsTweetLoading] = useState3(false);
  const createTweet = useCallback3(async () => {
    try {
  ...
  return /* @__PURE__ */ jsxs5(BlockWithAlignableContents, { className, format, nodeKey, children: [
    isTweetLoading ? loadingComponent : null,
    /* @__PURE__ */ jsx11("div", { style: { display: "inline-block", width: "550px" }, ref: containerRef })
  ] });
}
var tweetIDState = createState4("id", {
  parse: (v) => typeof v === "string" ? v : ""
});
var TweetNode = class extends DecoratorBlockNode {
  $config() {
  ...
  getId() {
    return $getState4(this, tweetIDState);
  }
...
function $createTweetNode(tweetID) {
  return $setState4($create4(TweetNode), tweetIDState, tweetID);
}

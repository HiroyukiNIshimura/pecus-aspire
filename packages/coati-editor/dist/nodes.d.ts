...
export declare function EquationComponent({ equation, inline, nodeKey }: EquationComponentProps): JSX.Element;

declare type EquationComponentProps = {
    equation: string;
    inline: boolean;
    nodeKey: NodeKey;
};
...
export declare function ImageComponent({ src, altText, nodeKey, width, height, maxWidth, resizable, showCaption, caption, captionsEnabled, }: {
    altText: string;
...
export declare function StickyComponent({ x, y, nodeKey, color, caption, }: {
    caption: LexicalEditor;
    color: 'pink' | 'yellow';
    nodeKey: NodeKey;
    x: number;

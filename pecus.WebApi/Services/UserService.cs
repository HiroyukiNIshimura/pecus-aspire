...
public class UserService
{
    ...
    )
    {
        ...
        try
        {
            ...
            var (token, tokenExpiresAt) = UserEntityFactory.GeneratePasswordResetTokenWithExpiry();

            // User, UserSetting, ChatActor を一括作成
            var (user, setting, chatActor) = UserEntityFactory.CreateUserEntities(
                loginId: loginId,
            ...
            _context.ChatActors.Add(chatActor);
            await _context.SaveChangesAsync();
